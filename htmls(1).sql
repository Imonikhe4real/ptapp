...
INSERT INTO `htmls` (`id`, `fullname`, `answer1`, `answer2`, `answer3`, `answer4`, `answer5`, `answer6`, `answer7`, `answer8`, `answer9`, `answer10`, `created_at`, `updated_at`) VALUES
(1, 'Krishna', 'HTML', 'top and bottom', 'font border', 'it is used for next line', 'used for background color', 'To divide written text', 'src', '6', 'secured', 'protocol', NULL, NULL);
