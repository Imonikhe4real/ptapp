...
class JavascriptconfirmController extends Controller
{
    public function index()
    {
        return view('javascriptconfirm');
    }
    public function store(Request $request)
     {
         ...
         DB::table('javascripts')->insert($sql);
 
         return redirect('javascriptconfirm')->with(array(
              'fullname' => $fullname,
              'answer1' => $answer1,
              'answer2' => $answer2,
              'answer3' => $answer3,
